...
# Plot the graphic of the actual time series and the ePL-KRLS-DISCO predictions
plt.plot(y_train, label='Actual Value', color='red')
plt.plot(OutputTrainingDenormalized, color='blue', label='ePL-KRLS-DISCO')
plt.ylabel('Output')
plt.xlabel('Samples')
plt.legend()
plt.show()
